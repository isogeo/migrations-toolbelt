...
"""
    Name:         Migration script for Rouen metadata in 2020
    Author:       Isogeo
...
if __name__ == "__main__":
    ...
    log_file_handler = RotatingFileHandler(
        Path("./scripts/rouen/migration/_logs/migration_rouen.log"), "a", 5000000, 1
    )
    ...
    with input_csv.open() as csvfile:
        ...
        for row in reader:
            ...
            if src_uuid != "source_uuid" and src_uuid != "09f1353a22404dc484571f7890b66797":
    ...
    if environ.get("BACKUP") == "1" and len(li_to_backup):
        ...
        backup_path = Path(r"./scripts/rouen/migration/_output/_backup")
