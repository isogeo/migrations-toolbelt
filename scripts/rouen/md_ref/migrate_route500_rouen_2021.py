...
if __name__ == "__main__":
    ...
    log_file_handler = RotatingFileHandler(
        Path("./scripts/rouen/md_ref/_logs/migration_Route500_rouen.log"), "a", 5000000, 1
    )
    ...
    li_to_backup = []
    # prepare csv reading
    input_csv = Path(r"./scripts/rouen/md_ref/csv/matching_route500.csv")
    ...
    csv_result = Path(r"./scripts/rouen/md_ref/csv/migrated_route500.csv")
    ...
    if len(li_failed) > 0:
        ...
        csv_failed = Path(r"./scripts/rouen/md_ref/csv/migrate_failed_route500.csv")
