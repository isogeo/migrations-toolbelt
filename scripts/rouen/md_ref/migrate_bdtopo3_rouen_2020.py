...
"""
    Name:         Migration script to Migrate BD TOPO 3 for Rouen
    Author:       Isogeo
...
if __name__ == "__main__":
    ...
    log_file_handler = RotatingFileHandler(
        Path("./scripts/rouen/md_ref/_logs/migration_BDTopo3_rouen.log"), "a", 5000000, 1
    )
    ...
    csv_result = Path(r"./scripts/rouen/md_ref/csv/migrated_bdtopo3.csv")
    ...
    if len(li_failed) > 0:
        ...
        csv_failed = Path(r"./scripts/rouen/md_ref/csv/migrate_failed_bdtopo3.csv")
