...
"""
    Name:         Migration script for "Grand Belfort" workgroup metadata in 2020
    Author:       Isogeo
...
if __name__ == "__main__":
    ...
    log_file_handler = RotatingFileHandler(
        Path("./scripts/belfort/_logs/migration_belfort.log"), "a", 5000000, 1
    )
    ...
    if int(environ.get("BACKUP")) and len(li_to_backup):
        ...
        backup_path = Path(r"./scripts/belfort/_output/_backup")
    ...
    csv_result = Path("./scripts/belfort/csv/migrated_{}.csv".format(datetime.now().timestamp()))
    ...
    if len(li_failed) > 0:
        ...
        csv_failed = Path(r"./scripts/belfort/csv/migrate_failed.csv")
