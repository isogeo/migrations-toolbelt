...
"""
    Name:         Migration script to Migrate BD TOPO 3 for AMP
    Author:       Isogeo
...
if __name__ == "__main__":
    ...
    log_file_handler = RotatingFileHandler(
        Path("./scripts/AMP/md_ref/_logs/migration_BDTopo3_AMP.log"), "a", 5000000, 1
    )
    ...
    csv_result = Path(r"./scripts/AMP/md_ref/bd_topo_3/csv/migrated.csv")
    ...
    if len(li_failed) > 0:
        ...
        csv_failed = Path(r"./scripts/AMP/md_ref/bd_topo_3/csv/migrate_failed.csv")
