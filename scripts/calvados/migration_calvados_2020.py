...
"""
    Name:         Migration script for "Département du Calvados" workgroup metadata in 2020
    Author:       Isogeo
...
if __name__ == "__main__":
    ...
    log_file_handler = RotatingFileHandler(
        Path("./scripts/calvados/_logs/migration_calvados.log"), "a", 5000000, 1
    )
    ...
    csv_result = Path("./scripts/calvados/csv/migrated_{}.csv".format(datetime.now().timestamp()))
    ...
    if len(li_failed) > 0:
        ...
        csv_failed = Path(r"./scripts/calvados/csv/migrate_failed.csv")
