...
if __name__ == "__main__":
    ...
    input_csv = Path(r"./scripts/misc/events/csv/corrupted_v12.csv")
    fieldnames = [
        "wg_name",
        "wg_uuid",
        "md_uuid",
    ...
    csv_path = Path("./scripts/misc/events/csv/coordSys_cleaner_{}.csv".format(str(datetime.now().timestamp()).split(".")[0]))
