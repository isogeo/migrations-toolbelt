...
if __name__ == "__main__":
    ...
    log_file_handler = RotatingFileHandler(
        Path("./scripts/misc/delete_md/delete_cat_md.log"), "a", 5000000, 1
    )
    ...
    logger.info("Retrieving metadatas to delete from {} catalog of {} workgroup".format(cat_deletion_target, wg_deletion_target))
