...
"""
    Name:         Migration script for Mayenne data in 2020
    Author:       Isogeo
...
if __name__ == "__main__":
    ...
    li_to_backup = []
    # prepare csv reading
    input_csv = Path(r"./scripts/mayenne/csv/correspondances_other.csv")
    fieldnames = [
        "source_uuid",
        "source_title",
        "source_name",
    ...
    csv_result = Path(r"./scripts/mayenne/csv/migrated.csv")
    ...
    if len(li_failed) > 0:
        ...
        csv_failed = Path(r"./scripts/mayenne/csv/migrate_failed.csv")
