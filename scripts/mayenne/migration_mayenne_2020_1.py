...
"""
    Name:         Migration script for Mayenne "Conseil départemental de la Mayenne Interne" workgroup data in 2020
    Author:       Isogeo
...
if __name__ == "__main__":
        ...
        # then, dupplicate the metadata
            ...
            try:
                md_dst = src_migrator.import_into_other_metadata(
                    ...
                    copymark_catalog=environ.get("ISOGEO_CATALOG_MIGRATED_1"),
                    destination_metadata_uuid=trg_uuid,
                    exclude_fields=li_exclude_fields,
                    exclude_catalogs=environ.get("ISOGEO_CATALOG_SOURCE_1"),
    ...
    csv_result = Path(r"./scripts/mayenne/csv/migrated_1.csv")
    ...
    if len(li_failed) > 0:
        ...
        csv_failed = Path(r"./scripts/mayenne/csv/migrate_failed_1.csv")
